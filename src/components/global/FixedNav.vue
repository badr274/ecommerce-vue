      ...
      <v-container fluid>
        <v-row>
          ...
          <v-col
            ...
            style="gap: 20px"
          >
            <svg data-icon="search" viewBox="0 0 512 512" width="28px">
              <path
                fill="#fff"
            ...
            <div
              class="wishlists d-flex flex-column align-center text-#ffb547"
              :style="`color: #ffb547; cursor: pointer; pointer-events: ${
